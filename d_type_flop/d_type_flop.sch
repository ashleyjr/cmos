...
U 1 1 5A566F1F
P 7200 4250
F 0 "#PWR8" H 7200 4000 50  0001 C CNN
...
U 1 1 5A567624
P 10050 3750
F 0 "#PWR11" H 10050 3500 50  0001 C CNN
...
U 1 1 5A568601
P 5850 4250
F 0 "#PWR6" H 5850 4000 50  0001 C CNN
...
U 1 1 5A568E82
P 4550 4250
F 0 "#PWR4" H 4550 4000 50  0001 C CNN
...
U 1 1 5A569C27
P 5850 2750
F 0 "#PWR5" H 5850 2600 50  0001 C CNN
...
U 1 1 5A569E22
P 7200 2750
F 0 "#PWR7" H 7200 2600 50  0001 C CNN
...
U 1 1 5A569E7D
P 8950 2750
F 0 "#PWR9" H 8950 2600 50  0001 C CNN
...
U 1 1 5A569F68
P 10050 2750
F 0 "#PWR10" H 10050 2600 50  0001 C CNN
...
+PSPICE\n\nV1 GNDREF 0 DC 0\nV2 +3V3 GNDREF DC 3.3 \nV3 R GNDREF DC 3.3 \nV4 D GNDREF ac sin(1.65 1.65 100)\nV5 CLK GNDREF ac sin(1.65 1.65 1000)\n\n.control\n\ntran 0.1m 30m\nplot V(D) V(CLK) V(Q) V(nQ) V(N)\n\n.endc\n
...
U 1 1 5A57E523
P 3750 5000
F 0 "X13" H 4400 5050 50  0000 R CNN
F 1 "BSS84LT1" H 4400 4950 50  0000 R CNN
...
U 1 1 5A57E586
P 3750 5550
F 0 "X14" H 4400 5500 50  0000 R CNN
F 1 "BSS138LT1" H 4400 5600 50  0000 R CNN
...
U 1 1 5A57E800
P 3850 5800
F 0 "#PWR2" H 3850 5550 50  0001 C CNN
F 1 "GNDREF" H 3850 5650 50  0000 C CNN
...
U 1 1 5A57E9CB
P 3850 4750
F 0 "#PWR1" H 3850 4600 50  0001 C CNN
